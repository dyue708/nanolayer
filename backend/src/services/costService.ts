export class CostService {
  ...
  private loadCosts() {
    ...
    this.costs.set('vertex/nano-banana', parseFloat(process.env.COST_VERTEX_NANO_BANANA || '0.039'));
    this.costs.set('vertex/nano-banana/edit', parseFloat(process.env.COST_VERTEX_NANO_BANANA_EDIT || '0.039'));
